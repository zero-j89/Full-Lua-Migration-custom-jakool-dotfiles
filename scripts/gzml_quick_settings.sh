#!/usr/bin/env bash
# Rofi menu for GZML Quick Settings (SUPER SHIFT E)
...
main() {
    ...
    case "$choice" in
        ...
        "Edit User Startup Apps (overlay)") file="$UserConfigs/UserStartup_Apps.lua" ;;
        ...
        "Edit Animations") file="$UserConfigs/UserAnimations.lua" ;;
