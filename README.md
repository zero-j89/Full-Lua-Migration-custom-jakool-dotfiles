...
5/16/2026 Edit: Fixed rainbow borders save state for reboot(new script added) also change fixed and renamed Startup_apps in/UserConcfigs to now UserStartup_apps.. fixed corresponding terms in hyprland.lua accordingly.
